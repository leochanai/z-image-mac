export const locales = {
  zh: {
    ...
    hero: {
      ...
      title2: "未来",
      title2Highlight: "无限",
      description: "AI 驱动的图像生成与编辑工具。从文字到画面，从创作到精修。专为 Apple Silicon 优化。",
  ...
  en: {
    ...
    hero: {
      ...
      title2: "FUTURE",
      title2Highlight: "THE",
      description: "AI-powered image generation and editing. From text to visuals, from creation to refinement. Optimized for Apple Silicon.",
